...
<Row>
    <div class="col-xl-3 col-md-6">
        <DashboardCard cardTitle="Pengaduan Masuk" cardColor="primary" />
    </div>
    <div class="col-xl-3 col-md-6">
        <DashboardCard cardTitle="Pengaduan Diproses" cardColor="warning" />
    </div>
    <div class="col-xl-3 col-md-6">
        <DashboardCard cardTitle="Pengaduan Selesai" cardColor="success" />
    </div>
    <div class="col-xl-3 col-md-6">
        <DashboardCard cardTitle="Pengaduan Ditolak" cardColor="danger" />
    </div>
</Row>
